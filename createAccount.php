...
if ($_POST){
    ...
    $sql = "INSERT INTO customer (name,email,mobile, password_hash, filename, filetype,content,filesize,description) values(?, ?, ?, ?, ?, ?, ?, ?, ?)";
    $q = $pdo->prepare($sql);
	...
	header("Location: customer.php");
        ...
        $sql = "UPDATE customer  set absolutepath = ? WHERE id = ?";
        $q = $pdo->prepare($sql);
...
<div class="container">
    ...
    <form method="post" enctype="multipart/form-data" onsubmit="return Validate(this)">
        ...
        Mobile (123-456-7890): <br><input name="mobile" type="tel" placeholder="1234567890" required><br>
